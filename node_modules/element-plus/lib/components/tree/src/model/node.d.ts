...
import { FakeNode, TreeKey, TreeNodeChildState, TreeNodeData, TreeNodeLoadedDefaultProps, TreeNodeOptions } from "../tree.type.js";

//#region ../../packages/components/tree/src/model/node.d.ts
declare const getChildState: (node: Node[]) => TreeNodeChildState;
declare class Node {
  id: number;
  text: string | null;
  checked: boolean;
