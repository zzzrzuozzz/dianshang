...
type SimpleFunctionalComponentProps<T extends object> = {
  class?: JSX.IntrinsicAttributes['class'];
  style?: CSSProperties;
} & T;
type SimpleFunctionalComponent<E extends object = {
  [key: string]: any;
}> = FunctionalComponent<SimpleFunctionalComponentProps<E>>;
//#endregion
export { Alignment, AnyColumns, CellRenderer, CellRendererParams, ClassNameGetter, ClassNameGetterParams, Column, ColumnCellsType, ColumnCommonParams, Columns, CustomizedCellsType, DataGetter, DataGetterParams, DefaultCellsType, FixedDirection, HeaderCellRenderer, HeaderCellRendererParams, HeaderClassGetter, KeyType, RowCommonParams, SimpleFunctionalComponent, SimpleFunctionalComponentProps, SortBy, SortState, TableV2CustomizedHeaderSlotParam };