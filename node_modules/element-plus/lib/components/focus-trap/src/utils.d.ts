...
declare const focusReason: _$vue.Ref<"pointer" | "keyboard" | undefined, "pointer" | "keyboard" | undefined>;
declare const lastUserFocusTimestamp: _$vue.Ref<number, number>;
declare const lastAutomatedFocusTimestamp: _$vue.Ref<number, number>;
type FocusLayer = {
  paused: boolean;
  pause: () => void;
  resume: () => void;
