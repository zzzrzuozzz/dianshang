...
var date_picker_panel_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(props, { slots, emit, attrs }) {
		...
		if (require_types.isUndefined((0, vue.inject)("EP_PICKER_BASE", void 0))) (0, vue.provide)(require_constants.PICKER_BASE_INJECTION_KEY, { props: (0, vue.reactive)({ ...(0, vue.toRefs)(props) }) });
