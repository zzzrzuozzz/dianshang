...
declare const drawerProps: {
  ...
  readonly transition: EpPropFinalized<(new (...args: any[]) => string | _$vue.TransitionProps) | (() => DialogTransition) | (((new (...args: any[]) => string | _$vue.TransitionProps) | (() => DialogTransition)) | null)[], unknown, unknown, undefined, boolean>;
