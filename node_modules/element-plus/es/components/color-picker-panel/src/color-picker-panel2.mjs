import color_picker_panel_vue_vue_type_script_setup_true_lang_default from "./color-picker-panel.vue_vue_type_script_setup_true_lang.mjs";
...
//#endregion
export { color_picker_panel_default as default };
