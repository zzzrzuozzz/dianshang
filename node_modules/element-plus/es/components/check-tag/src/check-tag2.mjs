import check_tag_vue_vue_type_script_setup_true_lang_default from "./check-tag.vue_vue_type_script_setup_true_lang.mjs";
...
//#endregion
export { check_tag_default as default };
