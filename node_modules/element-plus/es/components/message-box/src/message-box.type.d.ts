...
type CloseFn = () => void;
interface MessageBoxActionHandlers {
  confirm: CloseFn;
  cancel: CloseFn;
  close: CloseFn;
}
...
//#endregion
export { Action, Callback, CloseFn, ElMessageBoxOptions, ElMessageBoxShortcutMethod, IElMessageBox, MessageBoxActionHandlers, MessageBoxData, MessageBoxInputData, MessageBoxInputValidator, MessageBoxState, MessageBoxType };