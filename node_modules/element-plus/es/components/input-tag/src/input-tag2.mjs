import input_tag_vue_vue_type_script_setup_true_lang_default from "./input-tag.vue_vue_type_script_setup_true_lang.mjs";
...
//#endregion
export { input_tag_default as default };
